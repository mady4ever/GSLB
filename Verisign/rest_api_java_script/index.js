(function (root, client) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ManagedDnsRestfulApiDocumentation = client(root.popsicle);
  }
  ...
  function Resource0 (uri, client) {
    ...
    this.v1 = new Resource1(uri + '/v1', client);
  };
  ...
  function Resource1 (uri, client) {
    ...
    this.accounts = new Resource2(uri + '/accounts', client);
    this.users = new Resource5(uri + '/users', client);
  };
  ...
  Resource2.prototype.accountId = function (/* ...args */) {
  ...
  function Resource3 (uri, client) {
    ...
    this.move = new Resource4(uri + '/move', client);
  };
  ...
  Resource4.prototype.post = function (body, options) {
    ...
    options.headers = extend({'Content-Type':undefined,Accept:undefined}, options.headers);
  ...
  function Resource5 (uri, client) {
    ...
    this.apikeys = new Resource6(uri + '/apikeys', client);
  };
  ...
  function Resource6 (uri, client) {
    ...
    this.my = new Resource7(uri + '/my', client);
  };
